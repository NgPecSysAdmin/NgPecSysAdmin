...
<#
	...
	.DESCRIPTION
		...
		This function takes events from Get-WinEvent and allows the selection
		of properties including properties from the Data section of
		the XML. You can select both the normal properties of the event and the named
		data properties. If there is a name conflict between a normal property
		and a named data property, then the data property will have 'DATA-' prefixing
		its property name.
