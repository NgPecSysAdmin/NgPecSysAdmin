...
{
    Update-Help -SourcePath C:\SANS\Day1-PowerShell\UpdateHelp -UICulture en-US -Recurse -ErrorAction SilentlyContinue | Out-Null
    "Why are you looking at this file?" | Out-File -FilePath "C:\SANS\Day1-PowerShell\UpdateHelp\XDROP.TXT"
}
